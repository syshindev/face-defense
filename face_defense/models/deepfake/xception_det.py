...
class XceptionDetector(BaseDetector):
    ...
    def __init__(self, config: DictConfig):
        ...
        self.input_size = config.get("input_size", [299, 299])
        self.threshold = config.get("threshold", 0.5)
        self.model = None

    def _load_model(self):
        # Load Xception with ImageNet pretrained weights, modify for binary classification
    ...
    def predict(self, face_image: np.ndarray) -> DetectorResult:
        ...
        try:
            ...
            return DetectorResult(
                ...
                metadata={"detector": "xception", "fake_prob": float(probs[0]), "real_prob": real_prob},
            )
            ...
            return DetectorResult(
                ...
                metadata={"detector": "xception", "error": str(e)},
            )
